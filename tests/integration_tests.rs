...
fn preview_success() {
    ...
    assert!(output.status.success(), "client preview exited with failure");
}
...
fn change_mode_success() {
    ...
    assert!(output.status.success(), "client change-mode exited with failure");
}
...
fn change_directory_success() {
    ...
    assert!(output.status.success(), "client change-directory exited with failure");
}
